		...
		synchronized (DeviceUuidFactory.class) {
			if (TextUtils.isEmpty(uuid)) {
				...
				if (TextUtils.isEmpty(uuid)) {
					...
					final String imsi = BaseUtils.getImsi(context);
					...
					if (!TextUtils.isEmpty(imei)) {
						...
						if (TextUtils.isEmpty(androidId)) {
							final String macAddr = this.getWifiMacAddress(context);
					...
					if (!TextUtils.isEmpty(firstId) || !TextUtils.isEmpty(secondId)) {
						...
						try {
							uuid = UUID.nameUUIDFromBytes(fullId.getBytes("utf8")).toString();
