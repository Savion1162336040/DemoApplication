...
protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    int width = measureDimension(DensityUtils.dp2px(getContext(), defaultSize), widthMeasureSpec);
    int height = measureDimension(DensityUtils.dp2px(getContext(), defaultSize), heightMeasureSpec);
